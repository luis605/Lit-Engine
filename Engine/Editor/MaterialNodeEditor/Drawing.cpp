...
void DrawMaterialNodeIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b,
    MaterialIconType type, bool filled, ImU32 color, ImU32 innerColor) {
    ...
    if (type == MaterialIconType::Flow) {
        ...
        const auto canvas = ImRect(
            rect.Min.x + margin + offset_x, rect.Min.y + margin + offset_y,
        ...
        drawList->PathBezierCubicCurveTo(tip_right, tip_right,
                                         tip_bottom + (tip_right - tip_bottom) *
                                                          tip_round);
        ...
        if (type == MaterialIconType::Circle) {
        ...
        if (type == MaterialIconType::Square) {
            if (filled) {
        ...
        if (type == MaterialIconType::RoundSquare) {
            if (filled) {
                const auto r = 0.5f * rect_w / 2.0f;
        ...
        } else if (type == MaterialIconType::Diamond) {
            if (filled) {
