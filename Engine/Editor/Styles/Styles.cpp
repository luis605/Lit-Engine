...
void SetStyleGray(ImGuiStyle* dst) {
    ...
    constexpr ImVec4 accentColor      = ImVec4(0.016f, 0.455f, 0.984f, 1.0f);
    constexpr ImVec4 mutedAccentColor = ImVec4(0.133f, 0.347f, 0.667f, 1.0f);
    // Text
    colors[ImGuiCol_Text] = ImVec4(0.95f, 0.95f, 0.95f, 1.00f);
    colors[ImGuiCol_TextDisabled] = ImVec4(0.97f, 0.97f, 0.97f, 1.00f);

    // Frames
    colors[ImGuiCol_FrameBg] = ImVec4(0.33f, 0.33f, 0.33f, 1.0f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4{0.37f, 0.37f, 0.37f, 1.0f};
    colors[ImGuiCol_FrameBgActive] = ImVec4{0.27f, 0.27f, 0.27f, 1.0f};
    ...
    colors[ImGuiCol_ButtonActive] = mutedAccentColor;
    colors[ImGuiCol_DragDropTarget] = accentColor;
    colors[ImGuiCol_Border] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);

    colors[ImGuiCol_Header] = ImVec4(0.124f, 0.128f, 0.140f, 1.000f);
    colors[ImGuiCol_HeaderHovered] = mutedAccentColor;
