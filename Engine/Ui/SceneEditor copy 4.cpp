...
void EditorCamera(void)
{
    ...
    Vector3 gizmo_arrow_position = {entity_in_inspector->position.x, entity_in_inspector->position.y + 6, entity_in_inspector->position.z};
    // Create a matrix to store the translation information
    ...
    gizmo_arrow.transform = MatrixTranslate(gizmo_arrow_position.x, gizmo_arrow_position.y, gizmo_arrow_position.z );
    entity_in_inspector->position.y = gizmo_arrow_position.y-entity_in_inspector->scale.y*6;
