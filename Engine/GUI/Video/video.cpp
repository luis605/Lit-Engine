...
void Video::openVideo(const char* filename) noexcept {
...
void Video::processVideoFrame() noexcept {
...
void Video::PlayCurrentFrame() noexcept {
...
Texture2D& Video::getTexture() noexcept {
    return texture;
}

bool Video::hasVideoStream() const {
